...
namespace NavDrawer.iOS
{
	...
	public class AppDelegate : UIApplicationDelegate
	{
		...
		//Public property to access Issues.storyboard file
		...
		public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
		{
			...
			var rootViewController = navController.TopViewController as RootViewController;
			rootViewController.ViewModel = new NavDrawerViewModel();
			return true;
		}
